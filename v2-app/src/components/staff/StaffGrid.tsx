...
export default function StaffGrid({ loading, staffList, roleLabels }: StaffGridProps) {
    return (
        <section
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-6 md:gap-10 items-stretch">
                {loading
                    ? Array.from({length: 2}).map((_, i) => (
                        <div key={i}
                             className="flex flex-col border border-cream-border rounded-sm overflow-hidden animate-pulse">
