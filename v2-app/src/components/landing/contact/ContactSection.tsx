...
export default function ContactSection() {
  return (
    <>
      ...
      <section className="grid grid-cols-1 md:grid-cols-2 gap-10 md:gap-20 border-t border-white-border pt-12 px-6 md:px-20 pb-20 animate-fade-up">
        <div className="flex flex-col gap-9 animate-fade-up [animation-delay:150ms]">
          <div>
            ...
            <div className="border border-white-border p-8 flex flex-col gap-6">
              ...
              <div className="flex flex-col sm:flex-row gap-4">
                <Link
                  ...
                  className="inline-flex items-center justify-center gap-2 bg-up-maroon text-white text-xs font-bold tracking-widest uppercase px-6 py-4 hover:opacity-90 transition-opacity"
                >
              ...
              <p className="text-xs text-text-white-light mt-2">
          ...
          <div>
            ...
            <div className="border border-white-border overflow-hidden">
              <iframe
            ...
            <div className="border border-white-border divide-y divide-white-border">
              <div className="flex gap-5 items-center py-4 px-4">
                ...
                <div className="flex flex-col text-sm leading-6">
                  ...
                  <div className="text-text-white-light">
          ...
          <div>
            ...
            <div className="border border-white-border divide-y divide-white-border">
              <Link
                ...
                target="_blank"
                rel="noopener noreferrer"
                className="flex gap-5 items-center py-4 px-4 hover:bg-white-dark transition-colors"
              >
