    ...
    return (
        <section className="py-16 border-b border-white-border animate-fade-up [animation-delay:250ms]">
            <div className="max-w-3xl mx-auto text-center">
                <FaQuoteLeft className="text-4xl text-white-border block mb-6" />
                <p className="italic text-text-primary leading-9 text-xl md:text-2xl mb-6">
                ...
                <p className="text-text-white-light text-xs tracking-widest uppercase">
