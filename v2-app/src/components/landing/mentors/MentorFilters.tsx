                    ...
                    <div className="flex gap-1">
                        <button
                            ...
                            className={`px-3 py-1.5 text-xs font-bold rounded transition ${
                                selectedDay === '' ? 'bg-up-maroon text-white shadow-md' : 'bg-white text-slate-600 border border-gray-200 hover:bg-gray-100 cursor-pointer'
                            }`}
                            >
                                All
                        </button>
                        {DAYS.map((day) => (
                            <button
                                ...
                                className={`px-3 py-1.5 text-xs font-bold rounded transition ${
                                selectedDay === day ? 'bg-up-maroon text-white shadow-md' : 'bg-white text-slate-600 border border-gray-200 hover:bg-gray-100 cursor-pointer'
                            }`}
                            >
                                {day}
                            </button>
