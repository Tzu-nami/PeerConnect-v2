                ...
                <div className="flex flex-col sm:flex-row gap-3 items-stretch sm:items-center w-full md:w-auto">
                    ...
                    <div className="relative w-full sm:w-auto">
                        <select
                            ...
                            className="appearance-none px-4 py-2 pr-10 text-xs font-medium text-text-primary border border-white-border rounded-lg bg-white outline-none focus:ring-1 focus:border-text-brown-light focus:ring-text-brown-light/30 transition-shadow h-[36px] min-w-[150px] w-full sm:w-auto shadow-sm cursor-pointer"
                        >
                    ...
                    <button
                        ...
                        className="px-4 py-2 text-xs font-bold text-text-white-light border border-white-border rounded-lg bg-white hover:bg-white-hover transition h-[36px] w-full sm:w-auto shadow-sm cursor-pointer"
                    >
                        Reset
                    </button>
                </div>
