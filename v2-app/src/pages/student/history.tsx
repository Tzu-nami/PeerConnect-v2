...
import { FaBan, FaCircleCheck, FaHourglassHalf, FaListCheck, FaStopwatch } from "react-icons/fa6";
...
export default function StudentHistoryPage({ bookings, stats, semesters, selectedSemesterId }: Props) {
